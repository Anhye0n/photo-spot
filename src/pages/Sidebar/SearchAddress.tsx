   ...
   const addMarker = (position: any, idx: any) => {
      let imageSrc = markerImages, // 마커 이미지 url, 스프라이트 이미지를 씁니다
         ...
         imgOptions = {
            ...
            spriteOrigin: new kakao.maps.Point(0, idx * 46 + 8), // 스프라이트 이미지 중 사용할 영역의 좌상단 좌표
   ...
   return (
      <>
         <div className="option">
            <div>
               <p>원하는 지역으로 빠르게 이동하기 위한 검색입니다.</p>
               <div id="label-box">
                  <label htmlFor="keyword">위치 검색</label>
               </div>
               <input
                  type="text"
                  value={keyword}
                  id="keyword"
                  placeholder="예) 서울특별시 용산"
                  onChange={(e) => {
